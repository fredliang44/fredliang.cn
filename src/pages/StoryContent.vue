<template>
  <div>
    ...
    <Banner :imgSrc="articleList[articleList.findIndex(x => x.path == this.$route.path.split('/').pop())].bannersrc"/>
    <MarkdownRender :content="articleList[articleList.findIndex(x => x.path == this.$route.path.split('/').pop())].content"/>
  </div>
</template>
